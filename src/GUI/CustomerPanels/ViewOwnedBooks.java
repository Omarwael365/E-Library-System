...
public class ViewOwnedBooks extends JPanel {
    MainFrame mainFrame;
    Customers customer;

    public ViewOwnedBooks(MainFrame mainFrame, Customers customer) {
        ...
        JLabel titleLabel = new JLabel("Owned Books", JLabel.CENTER);
        ...
        ArrayList<Books> bookList = customer.getOwnedBookList();
